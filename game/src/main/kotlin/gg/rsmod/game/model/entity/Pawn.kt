...
abstract class Pawn(val world: World) : Entity() {
    ...
    /**
     * Boolean flag to check whether pawn is frozen
     */
    var frozen = false;
    ...
    fun applyTint(start:Int, end:Int, hue:Int, saturation:Int, luminance:Int, recolourAmount:Int) {
        applyTintSend(-1, 0, 0, 0, 0, 0)
        applyTintSend(start, end, hue, saturation, luminance, recolourAmount)
    }
    private fun applyTintSend(start:Int, end:Int, hue:Int, saturation:Int, luminance:Int, recolourAmount:Int){
        blockBuffer.maskStartCycle = start
        blockBuffer.maskEndCycle = end
        blockBuffer.maskHue = hue
        blockBuffer.maskSaturation = saturation
        blockBuffer.maskLuminance = luminance
        blockBuffer.maskRecolourAmount = recolourAmount
...
//        return BFSPathFindingStrategy(collision)
