...
enum class InterfaceDestination(val interfaceId: Int, val fixedChildId: Int, val resizeChildId: Int, val resizeListChildId: Int,
    ...
    INVENTORY(interfaceId = 149, fixedChildId = 82, resizeChildId = 78, resizeListChildId = 75, fullscreenChildId = 18),
    EQUIPMENT(interfaceId = 387, fixedChildId = 83, resizeChildId = 79, resizeListChildId = 76, fullscreenChildId = 19),
    PRAYER(interfaceId = 541, fixedChildId = 84, resizeChildId = 80, resizeListChildId = 77, fullscreenChildId = 20),
    MAGIC(interfaceId = 218, fixedChildId = 85, resizeChildId = 81, resizeListChildId = 78, fullscreenChildId = 21),
    CLAN_CHAT(interfaceId = 707, fixedChildId = 86, resizeChildId = 82, resizeListChildId = 79, fullscreenChildId = 22),
    ACCOUNT_MANAGEMENT(interfaceId = 109, fixedChildId = 87, resizeChildId = 83, resizeListChildId = 80, fullscreenChildId = 23),
    SOCIAL(interfaceId = 429, fixedChildId = 88, resizeChildId = 84, resizeListChildId = 81, fullscreenChildId = 24),
    LOG_OUT(interfaceId = 182, fixedChildId = 89, resizeChildId = 85, resizeListChildId = 82, fullscreenChildId = 25),
    SETTINGS(interfaceId = 116, fixedChildId = 90, resizeChildId = 86, resizeListChildId = 83, fullscreenChildId = 26),
    EMOTES(interfaceId = 216, fixedChildId = 91, resizeChildId = 87, resizeListChildId = 84, fullscreenChildId = 27),
    ...
    OVERLAY(interfaceId = -1, fixedChildId = 28, resizeChildId = 6, resizeListChildId = 43, fullscreenChildId = 29);
//    PVP_OVERLAY(interfaceId = 90, fixedChildId = 28, resizeChildId = 94, resizeListChildId = 91, fullscreenChildId = 1 );
