...
on_command("yeehaa", Privilege.ADMIN_POWER, description = "Teleports you to Yeehaa Stronghold") {
    player.moveTo(Tile(x = 2461, z = 3443, height = 0))
}

on_command("firecape", Privilege.ADMIN_POWER, description = "Teleports you to the fight caves") {
    player.teleport(Tile(x = 2439, z = 5168, height=0), TeleportType.ANCIENT)
}
